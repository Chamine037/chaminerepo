...
import ClienteSumario from './ClienteSumario'
...
class ConsultarCliente extends Component {
    ...
    handleClick = (e) => {
        ...
        e.preventDefault();
        axios.get('https://10.9.10.37:3000/clientes/' + localStorage.getItem('cli_id')).then(response => this.setState({ clientes: response.data }))
    }
                ...
                <div className="container">
                    ...
                    <div className="card z-depth-0 project-summary">
                        <div className="card-content grey-text text-darken-3">
                            <h2 className="grey-text text-darken-3 center">Dados do Cliente</h2>
                        </div>
                    </div>
                    <div className="mostrarclientes-group">
                        <label> <h6>
                            <ClienteSumario cliente={this.state.clientes} />
                        </h6>
                        </label>
                    </div>
                    <div className="right">
